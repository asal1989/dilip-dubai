    ...
    <section id="projects" className="bg-off py-24 sm:py-28">
      <div className="mx-auto max-w-[1280px] px-5 sm:px-8">
        <Reveal className="flex flex-wrap items-end justify-between gap-6">
          ...
          <a
            href="#contact"
            className="group inline-flex items-center gap-2 border border-navy/20 px-5 py-3 text-[0.7rem] font-semibold uppercase tracking-[0.16em] text-navy transition-colors hover:border-teal hover:text-teal"
          >
            View All Projects
